...
import { generarPalabraLarga } from '../utils/valorAleatorio';
...
test.describe('API - Crear guía de Recaudo', () => {
  ...
  test('Crear guía con referencia inválida y mostrar error de API', async () => {
    const guiaModificada = { ...guiaBase };
    guiaModificada.referenciaRecaudo = generarPalabraLarga();
