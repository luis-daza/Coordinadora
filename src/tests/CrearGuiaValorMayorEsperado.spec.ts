...
import { generarValorAleatorioNoPermitido } from '../utils/valorAleatorio';
...
test.describe('API - Crear guía de Recaudo', () => {
  ...
  test('Crear guía con valor recaudo mayor al esperado y mostrar error de API', async () => {
    const guiaModificada = { ...guiaBase };
    guiaModificada.valorRecaudar = generarValorAleatorioNoPermitido().toString();
